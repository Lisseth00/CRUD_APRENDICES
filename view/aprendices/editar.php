    ...
    <div class="card mb-4" style="background-color: #fff; border: 1px solid #08b822; border-radius: 10px;">
        ...
        <div class="card-body row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="tel" name="telefono" class="form-control" value="<?= $date['telefono'] ?>" style="background-color: #f8f9fa; border: 1px solid #08b822;" pattern="[0-9]{7,10}" title="Ingresa un número de teléfono de 7 a 10 dígitos sin espacios ni símbolos" required>
            </div>
        </div>
    </div>
